    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div style="width:800px"  align="center">
              <table border="1" style="height: 414px; width: 800px">
               <tr>
                   <td class="auto-style1"  style="height: 100px; width: 100px"> 
            <h3> Adres:</h3>
         ESKİŞEHİR OSMANGAZİ ÜNİVERSİTESİ REKTÖRLÜĞÜ, SAĞLIK KÜLTÜR VE SPOR DAİRE BAŞKANLIĞI, MEŞELİK KAMPÜSÜ - ESKİŞEHİR

            <h3> Telefon:</h3>
          (0222) 2393750 - 5301<br />

            <h3> Belgegeçer:</h3>
            (0222) 2292755

            <h3>E-Posta</h3>
            sksdairebaskanligi@ogu.edu.tr
                  
            <h3>Web:</h3>
             www.oguspor.edu.tr  </td> 
                    </tr>
